...
pub use crate::bindings::{
    sqlite3,
    sqlite3_api_routines as api_routines,
    sqlite3_context as context,
    ...
    sqlite3_module as module,
    sqlite3_stmt as stmt,
    sqlite3_uint64 as uint64,
    sqlite3_value as value,
    sqlite3_vtab as vtab,
    sqlite3_vtab_cursor as vtab_cursor,
    sqlite_int64 as int64,
    SQLITE_DETERMINISTIC as DETERMINISTIC,
    SQLITE_DIRECTONLY as DIRECTONLY,
    ...
    SQLITE_INDEX_CONSTRAINT_REGEXP as INDEX_CONSTRAINT_REGEXP,
    SQLITE_INNOCUOUS as INNOCUOUS,
    SQLITE_PREPARE_NORMALIZE as PREPARE_NORMALIZE,
    SQLITE_PREPARE_NO_VTAB as PREPARE_NO_VTAB,
    SQLITE_PREPARE_PERSISTENT as PREPARE_PERSISTENT,
    SQLITE_UTF8 as UTF8,
};
...
pub fn vtab_config(db: *mut sqlite3, options: i32) -> c_int {
    unsafe { invoke_sqlite!(vtab_config, db, options) }
}
